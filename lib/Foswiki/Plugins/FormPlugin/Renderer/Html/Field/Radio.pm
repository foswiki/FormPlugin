...
package Foswiki::Plugins::FormPlugin::Renderer::Html::Field::Radio;
...
sub _render {
    ...
    my $rendered = CGI::fieldset(
        ...
        CGI::radio_group($renderingAttributes)
    );
...
sub _extraAttributes {
    ...
    $attributes->{class} ||= '';
    $attributes->{class} .= ' foswikiRadioButton';
    $attributes->{class} .= ' foswikiRadioButtonDisabled'
      if $options->{disabled};
